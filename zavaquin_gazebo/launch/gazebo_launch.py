...
def generate_launch_description():
    ...
    pkg_path = FindPackageShare(package="zavaquin_gazebo").find("zavaquin_gazebo")
    pkg_description = FindPackageShare(package="zavaquin_description").find(
        "zavaquin_description"
    )
    pkg_gazebo_ros = FindPackageShare(package="gazebo_ros").find("gazebo_ros")

    gazebo_params_file = os.path.join(pkg_path, "config/gazebo_params.yaml")
    world_filename = "empty.world"
    world_path = os.path.join(pkg_description, "worlds", world_filename)
    ...
    start_spawner_cmd = Node(
        ...
        output="screen",
        arguments=["-topic", "robot_description", "-entity", "zavaquin"],
    )
